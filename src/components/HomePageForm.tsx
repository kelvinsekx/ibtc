...
const HomepageSignUpForm = ({onSubmit, setUserMail, ifSubmitted, userMail}) => (
    ...
    >
        ...
        <footer className='text-sm mt-4'>We officially launched in March, 2022, read <Link to="/blog/welcome" className="hover:text-gray-800">Our welcome message to learn more</Link></footer>
    </form>
)
